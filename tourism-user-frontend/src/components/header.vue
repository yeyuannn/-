    ...
    <div class="header1">
      ...
      <div class="header4">
        <div class="menu-list">
            ...
            <div @click="toPage('attractions')" :class="$route.path == '/attractions'?'menu_item':''">研学地点</div>
            <div @click="toPage('line')" :class="$route.path == '/line'?'menu_item':''">研学线路</div>
            <div @click="toPage('hotel')" :class="$route.path == '/hotel'?'menu_item':''">住宿预订</div>
            <div @click="toPage('forum')" :class="$route.path == '/forum'?'menu_item':''">研学资讯</div>
